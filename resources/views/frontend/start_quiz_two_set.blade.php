    ...
    <div class="container">
        ...
        <ul class="breadcrumbs mb-4 text-center">
            ...
            <li class="breadcrumbs__item">
                ...
                <a href="#" class="breadcrumbs__url">Question Set Two round {{ $type == 'one'? 'one':'two'}} </a>
            </li>
        </ul>
            ...
            <div class="col-lg-8">
                <div class="text-left">
                    ...
                    @foreach ($data as $item)
                        ...
                        <p class="text-justify">
                            Question {{ $item->serial_no??' ' }}. Lorem Ipsum has been the industry's
                            {{$item->question??' '}}
                        </p>
                        @if ($type == 'two')
                        ...
                        <div class="d-flex align-items-center pt-3">
                            ...
                            <div class="ml-auto">
                                <a href="{{ $nextPageUrl }}">
                                    <button type="button" class="btn btn-md btn-success" disabled> Next <i
