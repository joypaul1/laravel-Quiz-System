...
<div class="breadcrumb-area bg-gray-4 breadcrumb-padding-1">
    ...
    <div class="breadcrumb-img-1">
        <img src="{{URL::asset('frontend/assets/images/banner/breadcrumb-1.png')}}" alt="">
    </div>
    <div class="breadcrumb-img-2">
        <img src="{{URL::asset('frontend/assets/images/banner/breadcrumb-2.png')}}" alt="">
    </div>
</div>
            ...
            <div class="col-lg-12">
                ...
                <div class="myaccount-page-wrapper">
                    ...
                    <div class="row">
                        ...
                        <a  href="{{route('signout')}}"><i class='bx bx-log-out-circle'></i><span>Logout</span></a>
                    </div>
