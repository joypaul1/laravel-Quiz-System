                                ...
                                <div class="border border-3 p-4 rounded">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        @error('set_no') is-invalid @enderror">
                                            ...
                                            <option value="1" @if (old('set_no')==1)selected @endif>Set One</option>
                                            <option value="2" @if (old('set_no')==2)selected @endif>Set Two</option>
                                        </select>
                                        @error('set_no')
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="topic"
                                            ...
                                            value="{{old('topic')}}" placeholder="Enter Topic">
                                        @error('topic')
                                        <strong class="text-danger"> {{$message}} </strong>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="question"
                                            ...
                                            value="{{old('question')}}" placeholder="Enter sub title">
                                        @error('question')
                                        <strong class="text-danger"> {{$message}} </strong>
                                        @enderror
                                    </div>
                                    <div class="mb-3">
                                        ...
                                        <div class="form-row">
                                            <div class="col-md-6">
                                                <label for="inputCity">Option A</label>
                                                <input type="text" name="options[]" class="form-control"
                                                    placeholder="Enter option A">
                                            </div>
                                            <div class="col-md-6">
                                                <label for="inputCity">Option B</label>
                                                <input type="text" name="options[]" class="form-control"
                                                    placeholder="Enter option B">
                                            </div>
                                            <div class="col-md-6">
                                                <label for="inputCity">Option C</label>
                                                <input type="text" name="options[]" class="form-control"
                                                    placeholder="Enter option C">
                                            </div>
                                            <div class="col-md-6">
                                                <label for="inputCity">Option D</label>
                                                <input type="text" name="options[]" class="form-control"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="difficulty_rating"
                                            class="form-control @error('difficulty_rating') is-invalid @enderror"
                                            value="{{old('difficulty_rating')}}" placeholder="Enter difficulty rating"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="serial_no"
                                            ...
                                            value="{{old('serial_no')}}" placeholder="Enter serial no(Exm:1,2,3..)"
                                            onkeypress="return (event.charCode !=8 && event.charCode == 0 ||
                                     (event.charCode >= 48 && event.charCode <= 57))">
                                        @error('serial_no')
                                        <strong class="text-danger"> {{$message}} </strong>
